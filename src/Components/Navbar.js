...
function Navbar({ handleMenu, showMenu }) {
  return (
    ...
    <div>
      <Fade top cascade>
        <nav className="backdrop-blur-sm h-20 mx-6 md:mx-12 flex justify-between items-center fixed left-0 right-0 bg-white/95 z-50 transition-all duration-500">
          <Link href="#" to="intro" spy={true} smooth={true} offset={0} duration={1000} className="flex flex-row ">
          ...
          <Fade top cascade>
            <div className="hidden md:flex flex-row space-x-12 text-lg ">
              <Link href="#" to="intro" spy={true} smooth={true} offset={50} duration={1000} className="font-semibold">
                Intro
              </Link>
              <Link href="#" to="about" spy={true} smooth={true} offset={50} duration={1000} className="font-semibold">
                About
              </Link>
              <Link href="#" to="skills" spy={true} smooth={true} offset={50} duration={1000} className="font-semibold">
                Skills
              </Link>
              <Link href="#" to="work" spy={true} smooth={true} offset={50} duration={1000} className="font-semibold">
                Work
              </Link>
              <Link href="#" to="contact" spy={true} smooth={true} offset={50} duration={1000} className="font-semibold">
                Contact
              </Link>
            </div>
          </Fade>
